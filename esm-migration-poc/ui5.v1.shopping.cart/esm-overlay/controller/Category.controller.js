...
const [Device, Filter, FilterOperator, JSONModel, Fragment] = await requireUI5All(
	"sap/ui/Device",
	"sap/ui/model/Filter",
...
const CategoryController = BaseController.extend("sap.ui.demo.cart.controller.Category", {
	formatter,
