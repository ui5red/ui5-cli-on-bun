...
/**
 * Enumeration of the configurable log levels.
 * @enum {int}
 * @public
 */
Log.Level = {
...
// --- Module-level mutable state (preserved across imports via ESM singleton semantics) ---

let aLog = [];
let mMaxLevel = { '': Log.Level.ERROR };
let iLogEntriesLimit = 3000;
let oListener = null;
let bLogSupportInfo = false;
